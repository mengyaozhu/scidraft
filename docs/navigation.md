...
Four navigation surfaces: the header menus, prev/next between notes, the
numbered pagination bar, and the back-to-top link.
...
| `assets/css/common/menu.css` | Dropdown styling (hover for pointers, focus for keyboard) |
...
`layouts/_partials/numbered-pagination.html` + `assets/css/common/numbered-pagination.css`
