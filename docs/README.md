...
| Note recommendations | Box under every note (random notes) | `notes/single.html` (call) · `_partials/note-recommendations.html` · `assets/css/scidraft/note-recommendations.css` · `recommendationCount` | [note-recommendations.md](note-recommendations.md) |
...
| Entry map (multi-series) | A–Z + categories pages per series (occupation-a-to-z, skill-a-to-z, …) | `_shortcodes/entry-a-to-z.html`, `entry-categories.html` · `assets/css/scidraft/entry-map.css` · site `[params.entrySets.*]` · note front matter fields | [entry-map.md](entry-map.md) |
...
| Navigation | Header menus (with dropdowns), prev/next, numbered pagination | `_partials/header.html` · `assets/css/scidraft/menu.css` · `assets/js/menu-toggle.js` · `_partials/note-nav-links.html` · `_partials/numbered-pagination.html` · `assets/css/scidraft/numbered-pagination.css` | [navigation.md](navigation.md) |
...
| Asset loading | What each page loads, and from where | `layouts/_partials/extend_head.html` (script hub) · `layouts/_partials/head.html` (bundles) · `assets/js/*` | [asset-loading.md](asset-loading.md) |
