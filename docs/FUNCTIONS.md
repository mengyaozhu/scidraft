...
| Entry indexes (multi-series) | Map + categories pages per series (occupation-map, skill-map, …) | `_shortcodes/entry-map.html`, `entry-categories.html` · `assets/css/extended/entry-index.css` · site `[params.entrySets.*]` · note front matter fields | [entry-indexes.md](entry-indexes.md) |
