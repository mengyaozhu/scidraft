...
| Entry map (multi-series) | A–Z + categories pages per series (occupation-a-to-z, skill-a-to-z, …) | `_shortcodes/entry-a-to-z.html`, `entry-categories.html` · `assets/css/extended/entry-index.css` · site `[params.entrySets.*]` · note front matter fields | [entry-map.md](entry-map.md) |
